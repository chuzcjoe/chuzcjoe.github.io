...
Github source code: [link](https://github.com/chuzcjoe/opengl/tree/master/2-window)
learning materials: [learnopengl](https://learnopengl.com/Getting-started/Hello-Window)
...
`F1` closes the window. `F2` changes the color of the window.

<p align="center">
    <img src="f2.png" width="500px" height="500px">
</p>
